...
>>>>>>> 67186fac0092e9208737c928ccce2185105d9f51
\begin{figure}
\centering
\begin{minipage}{.3\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{1}
  \captionof{figure}{Meta Agent}
  \label{fig:1}
\end{minipage}%
\begin{minipage}{.3\textwidth}
  \centering
