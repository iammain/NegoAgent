...
\textcolor{red}{Use spacing between paragraphs instead of $\backslash\backslash$. By the way here are lot of typos.}
...
\textcolor{red}{Here you played too much whith the \textasciitilde , I deleted some, but then I got bored...}
...
It can be induced that an agent \textcolor{red}{?????}
\section{Conclusion}
